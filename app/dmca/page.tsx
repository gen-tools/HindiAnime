      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-text-secondary">
        ...
        <section className="rounded-xl border border-border-line bg-surface p-6 sm:p-8">
          <p className="text-base font-medium text-text-primary">
            Hindi Anime respects the rights of copyright owners.
          </p>
          <p className="mt-3">
            Hindi Anime does not intentionally host or store copyrighted video files on its own servers. Our website may provide links or embeds to content hosted by third-party services.
          </p>
          <p className="mt-3">
            If you are the copyright owner or an authorized representative and believe that content linked or displayed on Hindi Anime violates your copyright, you can contact us with a DMCA takedown request.
          </p>
        </section>
        ...
        <section className="rounded-xl border border-border-line bg-surface p-6 sm:p-8">
          ...
          <ul className="space-y-2.5">
            {[
              ...
              "The exact URL of the content on Hindi Anime",
          ...
          <div className="mt-6 rounded-lg border border-border-line bg-surface-dark p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <p className="text-xs text-text-muted">Send takedown notices to:</p>
              <p className="font-mono text-sm text-green-light font-medium">dmca@hindianime.com</p>
            </div>
            <a
              href="mailto:dmca@hindianime.com"
              className="focus-ring inline-flex items-center gap-1.5 rounded-lg bg-green-primary px-3.5 py-1.5 text-xs font-semibold text-white shadow hover:bg-green-primary/90 transition-colors shrink-0"
            >
        ...
        <section className="rounded-xl border border-border-line bg-surface p-6 sm:p-8">
          ...
          <p>
            Upon receiving a valid DMCA notice, we will review the request and take appropriate action, which may include removing or disabling access to the identified content.
          </p>
          <p className="mt-3">
        ...
        <section className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-6 sm:p-8">
          ...
          <p className="text-text-secondary">
            Hindi Anime does not claim ownership of third-party content.
          </p>
          <p className="mt-3 text-text-secondary">
            The availability of a link or embedded content on Hindi Anime does not mean that Hindi Anime owns or licenses that content.
          </p>
          <p className="mt-3 text-text-secondary">

...
export function LatestSection({ episodes = [] }: { episodes?: Episode[] }) {
  ...
  const uniqueEpisodes = deduplicateEpisodes(episodes);
      ...
      <div className="container-page">
        ...
        <div className="group/episodes relative">
          ...
          <div
            ...
            className="no-scrollbar -mx-1 flex items-stretch gap-4 overflow-x-auto scroll-smooth px-1 pb-2 pt-2"
          >
            {uniqueEpisodes.map((ep) => (
              <div key={getEpisodeIdentity(ep)} className="flex w-[280px] shrink-0 sm:w-[320px]">
